...
val FAFAFA = Color(0xFFFAFAFA) // Nền tổng thể bàn chung
...
val FFFEF4F4 = Color(0xFFFEF4F4) // ⚪ Trắng hơi hồng (Pinkish White)


// ✅ Trạng thái (Status Colors)
val FF28A745 = Color(0xFF28A745) // ✅ Xanh lá cây (Success Green)
val FFFF4C4C = Color(0xFFFF4C4C) // ❌ Đỏ cảnh báo (Alert Red)
val FFFFC107 = Color(0xFFFFC107) // ⚠️ Vàng cảnh báo (Warning Yellow)
