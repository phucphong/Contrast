...
object AppConfig {
    ...
    fun getToken(context: Context): String {
        return getSharedPreferences(context)
            .getString(KEY_TOKEN, "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.._Mbc-Jtxq8-cHGcvXX9WYRbM_ziYIpsarMsHp7k4nrs"
            ) ?: "" }
