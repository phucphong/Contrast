...
import com.contrast.Contrast.presentation.features.report.report_sales_Agency.TableHeaderAgencyRow
...
fun ReportUpToLevelScreen(
    ...
    Column {
        ...
        TableHeaderUptoLevelRow(
            ...
            stringResource(R.string.level_new_old),
            stringResource(R.string.total_revenue),
            stringResource(R.string.received_amount),
        )
